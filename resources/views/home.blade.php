                        ...
                        <div class="col-sm-6 col-xl-8">
                            <div class="card">
                                <div class="card-heading p-4 text-center">
                                    <div>
                                        <h5 class="font-16">Welcome</h5>
                                    </div>
                                    <h3 class="font-16">{{session('loggindata')['loggedinuser']['name']}}</h3>
                                    <h3 class="font-16">{{session('loggindata')['loggedinuser']['workingrole']}}</h3>
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="card">
                                <div class="card-heading p-4">
                                    @if(session()->has('changestoresuccess'))
                                        <div class="card-body">                                 
                                            <div class="alert alert-success" role="alert" style="margin-top: 10px;">
                                                {{ session()->get('changestoresuccess') }}
                                            </div>
                                        </div>
                                    @endif
                                    <div>
                                        ...
                                        @if(session('storeid')!="")
                                            @foreach(session('loggindata')['loggeduserstore'] as $storedetail)
                                            <h6>Store: {{$storedetail->store_name}}</h6>
                                            <h6>Address: {{$storedetail->store_address}}</h6>
                                            @endforeach
                                        @else
                                            @foreach(session('loggindata')['loggeduserstore'] as $storedetail)
                                            <h6>Store: {{$storedetail->store_name}}</h6>
                                            ...
                                            @endforeach
                                        @endif
                                        @if(session('loggindata')['loggedinuser']['usertypeRole']=='Admin')
                                        <hr>
                                        ...
                                        @else
                                            @if(session('loggindata')['loggedinuser']['usertypeRole']=='Admin')
                                            <h5 class="font-16">Please Select Store</h5>
