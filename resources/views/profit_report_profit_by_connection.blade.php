            ...
            <div class="container-fluid">
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <h4 class="page-title">Profit By Connection</h4>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-right">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Reports</a></li>
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Profit Report</a></li>
                                <li class="breadcrumb-item active">Profit By Connection</li>
                            </ol>
                        </div>
                    </div> <!-- end row -->
                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="collapse" id="collapseExample">
                                                <div class="card card-body mt-3 mb-0">
                                                    <form method="post" action="{{route('profitbyconnection')}}">
                                                        @csrf
                                                        <div class="row">
                                                            @if(session('loggindata')['loggeduserpermission']->viewreportprofitbyconnectionfilter=='Y')
                                                            <div class="col-md-3">
                                    ...
                                    <div class="table-responsive b-0" data-pattern="priority-columns">
                                        <table id="datatable-buttons" class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th data-priority="1">SP (Inc. GST)</th>
                                                <th data-priority="1">MAF</th>
                                                <th data-priority="6">Total Sold Price (Inc. GST)</th>
                                                <th>Discount</th>
                                                <th data-priority="6">Comission (Ex. GST)</th>
                                                <th data-priority="6">Bonus Out (Inc. GST)</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            @php
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$sales->customermobilenumber}}</td>
                                                <td>{{$sales->name}}</td>
                                                ...
                                                <td>
                                                    @if($sales->planpropositionname == 'APP')
                                                        {{App\productstockgroup::where('productID', $sales->productID)->where('stockgroupID', 4)->where('staffbonustype', 'percentage_dealermargin')->pluck('dealermargin')->first()}}
                                                        @php
                                                        $salecomission += App\productstockgroup::where('productID', $sales->productID)->where('stockgroupID', 4)->where('staffbonustype', 'percentage_dealermargin')->pluck('dealermargin')->first();
                                                        @endphp
                                                    @else
                                            ...
                                            <tr style="background-color: #f1525247;">
                                                ...
                                                <td>
                                                    @if($refund->planpropositionname == 'APP')
                                                        {{App\productstockgroup::where('productID', $refund->productID)->where('stockgroupID', 4)->where('staffbonustype', 'percentage_dealermargin')->pluck('dealermargin')->first()}}
                                                        @php
                                                        $salecomission += App\productstockgroup::where('productID', $refund->productID)->where('stockgroupID', 4)->where('staffbonustype', 'percentage_dealermargin')->pluck('dealermargin')->first();
                                                        @endphp
                                                    @else
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td style="font-size: 1.2em; font-weight: 600;">
                                                        @if($connectiondata['getconnection']->count() != 0)
                                                            @php
                                                            $salemaf = $salemaf / $connectiondata['getconnection']->count();
                                                            @endphp
                                                        @endif
                                                        @if($connectiondata['getrefundconnection']->count() != 0)
                                                            @php
                                                            $refundmaf = $refundmaf / $connectiondata['getconnection']->count();
                                                            @endphp
                                                        @endif
                                                    ...
                                                    <td style="font-size: 1.2em; font-weight: 600;">
                                                        {{$salecomission - $refundcomission}}
                                                    </td>
                                                    <td style="font-size: 1.2em; font-weight: 600;">
                                                        {{$salebonus - $refundbonus}}
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
