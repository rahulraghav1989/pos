                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card m-b-30">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    @foreach($instockdata['getdevice'] as $devices)
                                        ...
                                        >
                                            ...
                                            <td>
                                                @php
                                                $addeddate = date('Y-m-d', strtotime($devices->created_at));
                                                $currentdate = date('Y-m-d');
                                                $diff = strtotime($addeddate) - strtotime($currentdate); 
      
                                                
                                                echo abs(round($diff / 86400))." Days"; 
                                                @endphp
                                            </td>
	                                    </tr>
                                    	@endif
                            ...
                            <div class="card-body">
                                <h4 class="mt-0 header-title">APP Accessories</h4>
                                <table id="datatable1" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    @foreach($instockdata['getquantityproducts'] as $quantityproducts)
                                        @if(count($quantityproducts->productstockgroup) >= 2)
                                        <tr>
                                            ...
                                            <td>
                                                @foreach($quantityproducts->productstockgroup as $stockgroup)
                                                {{App\masterstockgroup::where('stockgroupID', $stockgroup->stockgroupID)->pluck('stockgroupname')->first()}}
                                                @endforeach
                                            </td>
                            ...
                            <div class="card-body">
                                <h4 class="mt-0 header-title">Outright Accessories</h4>
                ...
                $('#datatable3').DataTable( {
                    ...
                    buttons: [
                        ...
                        },
                        {
                            extend: 'excel',
                            text : 'Export Excel',
                            title: 'QuantityProductsInstock-outright',
                            exportOptions: {
                                columns: [0,2,3,4,5]
                            },
                        }
