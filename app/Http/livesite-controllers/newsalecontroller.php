        ...
        else
        {
            ...
            if($request->input('postpaiddevice') != '')
            {
                ...
                else
                {
                    ...
                    $plandetails = "Item: ".$productstock->productname.", ".$productstock->productimei."-".$productstock->stockgroupname.", Order Num: ".$ordernumber.", Ful. Order: ".$fulfilmentorder.", Number: ".$mobilenumber.", H.T: ".$getplan->planhandsettermduration.", P.T: ".$getplan->plantermname;
            ...
            else if($request->input('deferreddevice') != '')
            {
                ...
                $plandetails = "Item: ".$product->productname." - ".$product->brandname." - ".$product->colourname." - ".$product->modelname." - ".$product->stockgroupname." , Order Num: ".$ordernumber.", Ful. Order: ".$fulfilmentorder.", Number: ".$mobilenumber.", H.T: ".$getplan->planhandsettermduration.", P.T: ".$getplan->plantermname;
            ...
            else
            {
                ...
                $plandetails = "Order Num: ".$ordernumber.", Ful. Order: ".$fulfilmentorder.", Number: ".$mobilenumber;
