        ...
        else
        {
        	...
        	else if (!empty($imei))
        	{
                ...
                if($searchimei!="")
                {
                   $getdetail1 = productstock::where('productimei', $imei)
                    ...
                    if(count($storeID) > 0)
                    {
                        $getdetail1->whereIn('productstock.storeID', $storeID);
                    }
        	...
        	else if (!empty($barcode))
        	{
                ...
                if($productbarcode!="")
                {
                    ...
                    if(count($storeID) > 0)
                    {
                        $productstock1->whereIn('productstock.storeID', $storeID);
                    }
                    ...
                    if(count($storeID) > 0)
                    {
                        $productpo1->whereIn('productpurchaseorder.storeID', $storeID);
                    }
                    if($firstday!="" && $lastday!="")
                    {
                    ...
                    if(count($storeID) > 0)
                    {
                        $productorderdetail1->whereIn('orderdetail.storeID', $storeID);
                    }
                    if($firstday!="" && $lastday!="")
                    {
                    ...
                    if(count($storeID) > 0)
                    {
                        $productrefund1->whereIn('refundorderdetail.storeID', $storeID);
                    }
                    if($firstday!="" && $lastday!="")
                    {
                    ...
                    if(count($storeID) > 0)
                    {
                        $productstockreturn1->whereIn('stockreturn.storeID', $storeID);
                    }
                    if($firstday!="" && $lastday!="")
                    {
                    ...
                    if(count($storeID) > 0)
                    {
                        $productstocktransfer1->whereIn('stocktransfer.fromStoreID', $storeID); 
                    }
                    if($firstday!="" && $lastday!="")
                    {
                    ...
                    if(count($storeID) > 0)
                    {
                        $productstockintransfer1->whereIn('stocktransfer.toStoreID', $storeID); 
                    }
                    if($firstday!="" && $lastday!="")
                    {
