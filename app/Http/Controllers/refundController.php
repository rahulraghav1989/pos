...
class refundController extends Controller
{
                        ...
                        if($insertorderdetail->save())
                        {
                            foreach($request->input('itemid') as $k => $v)
                            {
                                ...
                                [
                                    ...
                                    'gstamount'=> $totalgst,
                                    'subTotal'=> $subtotal,
                                    'plandiscount'=>$getorderitem->plandiscount,
                                    'planexgstamount'=>$getorderitem->planexgstamount,
                                    'actualcomission'=>$getorderitem->actualcomission,
                                    'Comission'=>$comission,
    ...
    {   
        ...
        else
        {
            ...
            $getorderdetails1 = refundorderdetail::where('refundInvoiceID', $id)
            ...
            if(count($storeID) > 0)
            {
                $getorderdetails1->whereIn('refundorderdetail.storeID', $storeID);
            }
            $getorderdetails = $getorderdetails1->first();
    ...
    {   
        ...
        else
        {
            ...
            else
            {
                ...
                $checkorderitem = refundorderitem::where('refundInvoiceID', $refundinvoiceid)->count();
                ...
                {
                    return redirect()->back()->with('error', 'No product in this invoice. cant make refund');
                }
            }
        }
    }
    ...
    {   
        ...
        else
        {
            ...
            $saledetail1 = refundorderdetail::leftJoin('refundorderitem', 'refundorderitem.refundInvoiceID', '=', 'refundorderdetail.refundInvoiceID')
            ->leftJoin('products', 'products.productID', '=', 'refundorderitem.productID')
