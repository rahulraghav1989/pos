...
class HomeController extends Controller
{
    ...
    {   
        ...
        else
        {
            ...
            ->get(array('masterproducttype.producttypeID', 'masterproducttype.producttypename', 'masterproducttype.producttype', 'masterproducttype.productrestrictiontype', 'masterproducttype.productrestrictionword', 'masterproducttype.producttypestatus', 'masterproducttype.created_at', 'users.name'));
