                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form method="post" action="{{route('connectionprofitfilter')}}">
                                                        @csrf
                                                        <div class="row">
                            ...
                            <div class="card-body">
                                <p class="alert alert-warning">Showing Result: 
                                    <span style="font-weight: 600; color: #000;">
                                        ...
                                        Store (All Store) | 
                                        @else
                                        Store ( {{$connectiondata['storedetail']->store_name}} )
                                        @endif
                                        @if($connectiondata['userID'] == "")
                                        User (All Users) | 
                                        @else
                                        User ( {{$connectiondata['userdetail']->name}} )
                                        @endif
                                        Date (@php echo date('d-m-Y', strtotime($connectiondata['firstday'])) @endphp to @php echo date('d-m-Y', strtotime($connectiondata['lastday'])) @endphp)</span></p>
                                    ...
                                    <div class="table-responsive b-0" data-pattern="priority-columns">
                                        <table id="datatable-buttons" class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th data-priority="6">Comission (Inc. GST)</th>
                                            ...
                                            <tr style="background-color: #f1525247;">
                                                ...
                                                <td>-${{$refund->plancomission}}</td>
                                                <td>-${{$refund->Comission}}</td>
                                            </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
                    ...
                    buttons: [
                            {
                                extend: 'excel',
                                text : 'Export Excel',
                                title: 'ConnectionProfit-@php if($connectiondata['storedetail']!=""){ echo $connectiondata['storedetail']->store_name."-"; } if($connectiondata['userdetail']!=""){ echo $connectiondata['userdetail']->name."-"; } echo date('d-m-Y', strtotime($connectiondata['firstday']))."to".date('d-m-Y', strtotime($connectiondata['lastday'])) @endphp',
                            }
                        ]
                });
