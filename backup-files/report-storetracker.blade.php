                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="storeid" class="form-control">
                                                                                ...
                                                                                <option value="{{$allstore->store_id}}" @if($comissiondata['storeID']== $allstore->store_id) SELECTED='SELECTED' @endif>{{$allstore->store_name}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="col-sm-6 col-xl-3" data-toggle="modal" data-target=".comissionmodel{{$proposition->planpropositionname}}{{$proposition->pcname}}" data-backdrop="static" data-keyboard="false" style="cursor: pointer;">
                                            <div class="card" style="background-color: #30419b;">
                                                ...
                                                <div class="card-heading p-4">
                                                    ...
                                                    <h5 class="font-12" style="color: #FFF;">
                                                        Comission: ${{$comissiondata['getorderedplan']->where('planpropositionID', $proposition->planpropositionID)->where('plancategoryID', $proposition->pcID)->sum('Comission') - $comissiondata['getrefundorderedplan']->where('planpropositionID', $proposition->planpropositionID)->where('plancategoryID', $proposition->pcID)->sum('Comission')}}
                                                    </h5>
                                                    ...
                                                    <div class="progress mt-4" style="height: 20px;">
                                                        ...
                                                        aria-valuemin="0" 
                                                        aria-valuemax="100">
                                                            {{($comissiondata['getorderedplan']->where('planpropositionID', $proposition->planpropositionID)->where('plancategoryID', $proposition->pcID)->count() - $comissiondata['getrefundorderedplan']->where('planpropositionID', $proposition->planpropositionID)->where('plancategoryID', $proposition->pcID)->count()) * 100 / $comissiondata['storetarget']->where('targetcategory', $proposition->planpropositionname.$proposition->pcname)->sum('target')}}%
                                                        </div>
                                                    </div>
                                                    @endif
                                                </div>
                                                ...
                                                <div class="card-heading p-4">
                                                    ...
                                                    <div class="progress mt-4" style="height: 20px;">
                                                        ...
                                                        aria-valuemin="0" 
                                                        aria-valuemax="100">
                                                            {{($comissiondata['getorderedplan']->where('planpropositionID', $proposition->planpropositionID)->where('plancategoryID', $proposition->pcID)->sum('subTotal') - $comissiondata['getrefundorderedplan']->where('planpropositionID', $proposition->planpropositionID)->where('plancategoryID', $proposition->pcID)->sum('subTotal')) * 100 / $comissiondata['storetarget']->where('targetcategory', $proposition->planpropositionname.$proposition->pcname)->sum('target')}}%
                                                        </div>
                                                    </div>
                                                    @endif
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-xl-3" data-toggle="modal" data-target=".productcomissionmodel{{$key}}" data-backdrop="static" data-keyboard="false" style="cursor: pointer;">
                                            <div class="card" style="background-color: #3c9b30;">
                                                ...
                                                <div class="card-heading p-4">
                                                    ...
                                                    <h5 class="font-12" style="color: #FFF;">
                                                        Comission: ${{$comissiondata['productcategorysales']->where('categoryID', $productcategory->categoryID)->sum('Comission') -  - $comissiondata['refundproductcategorysales']->where('categoryID', $productcategory->categoryID)->sum('Comission')}}
                                                    </h5>
                                                    ...
                                                    <div class="progress mt-4" style="height: 20px;">
                                                        ...
                                                        aria-valuemin="0" 
                                                        aria-valuemax="100">
                                                            {{($comissiondata['productcategorysales']->where('categoryID', $productcategory->categoryID)->count() - $comissiondata['refundproductcategorysales']->where('categoryID', $productcategory->categoryID)->count()) * 100 / $comissiondata['storetarget']->where('targetcategory', $productcategory->categoryname)->sum('target')}}%
                                                        </div>
                                                    </div>
                                                    @endif
                                                </div>
                                                ...
                                                <div class="card-heading p-4">
                                                    ...
                                                    <div class="progress mt-4" style="height: 20px;">
                                                        ...
                                                        aria-valuemin="0" 
                                                        aria-valuemax="100">
                                                            {{($comissiondata['productcategorysales']->where('categoryID', $productcategory->categoryID)->sum('subTotal') - $comissiondata['refundproductcategorysales']->where('categoryID', $productcategory->categoryID)->sum('subTotal')) * 100 / $comissiondata['storetarget']->where('targetcategory', $productcategory->categoryname)->sum('target')}}%
                                                        </div>
                                                    </div>
                                                    @endif
                                                </div>
